...
export default function Hero({ isEn, t }: HeroProps) {
  return (
    <section
      id="hero"
      className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-white py-24"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center flex flex-col items-center justify-center">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-slate-800 leading-[1.2] mb-6 max-w-4xl tracking-tight"
        >
          {isEn ? (
            <>
              Elevating{" "}
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10 flex flex-col items-center gap-1.5 opacity-60">
        <div className="w-5 h-8 rounded-full border border-slate-400 flex justify-center p-1.5">
          <motion.div
            animate={{
              y: [0, 10, 0],
            }}
